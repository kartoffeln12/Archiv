<nav class="nav">
    ...
    <a <?php if ($nav_en_cours == 'archive') {echo ' id="en_cours"';} ?> href="index.php?page=archive">ARCHIVES</a>
   
    <a <?php if ($nav_en_cours == 'crea_page') {echo ' id="en_cours"';} ?> href="index.php?page=crea">Votre EVENT</a>
   
    <a <?php if ($nav_en_cours == 'upload') {echo ' id="en_cours"';} ?> href="index.php?page=upload">UPLOAD</a>
...
if (isset($_SESSION['Auth']['login']) && !empty($_SESSION['Auth']['login'])) {
	...
	echo "<a href='/admin/index_admin.php'>(Admin)</a>";
